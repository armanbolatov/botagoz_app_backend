...
async def answer_question_endpoint(question: Question, image: Optional[UploadFile] = None):
    answer = answer_question(question.question, image.file if image else None, question.user_id)
